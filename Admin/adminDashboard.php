...
<div class="col-sm-9 mt-5">
  <div class="row mx-5 text-center">
    <div class="col-sm-4 mt-5">
      <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-header font-weight-bold">Courses</div>
        <div class="card-body">
          <h4 class="card-title">
    ...
    <div class="col-sm-4 mt-5">
      <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
        <div class="card-header font-weight-bold">Students</div>
        <div class="card-body">
          <h4 class="card-title">
            <?php echo $totalstu; ?>
          </h4>
    ...
    <div class="col-sm-4 mt-5">
      <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-header font-weight-bold">Sold</div>
        <div class="card-body">
          <h4 class="card-title">
            <?php echo $totalsold; ?>
          </h4>
  ...
  <div class="mx-5 mt-5 text-center">
    <!--Table-->
    <p class=" text-white p-2 font-weight-bold" style="background-color: #225470;">Course Ordered</p>
    <?php
    $sql = "SELECT * FROM courseorder";
    $result = $conn->query($sql);

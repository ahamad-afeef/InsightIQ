...
<div class="col-sm-9 mt-5">
  <!--Table-->
  <p class="  text-white p-2 font-weight-bold" style="background-color: #225470;">List of Courses</p>
  <?php
...
<div><a class=" btn btn-danger box" href="./addCourse.php"><i class="fas fa-plus fa-2x"></i></a>
</div>

...
<div class="container-fluid remove-vid-marg">
  ...
  <div class="vid-content">
    <h1 class="my-content font-weight-bold" style=" font-family:Baskervville SC ;">Welcome to InsightIQ</h1>
    <small class="my-content">Where Smart Learners Thrive</small><br />
    <?php
...
<div class="container mt-5"> <!-- Start Most Popular Course -->
  ...
  <div class="text-center m-2">
    <a class="btn btn-primary btn-sm mt-5" href="courses.php">View All Course</a>
  </div>
...
<div class="container-fluid mt-5 mb-5" style="background-color: #225470;" id="Feedback">
  <h1 class="text-center text-white testyheading p-4"> Student's Feedback </h1>
  <div class="row">
    <div class="col-md-12">
...
<div class="container-fluid" style="background-color: #225470;" > <!-- Start Social Follow -->
  <div class=" row text-white text-center p-1 py-2">
  <div class="col-sm">
    <a class="text-white " href="#"><i class="fab fa-facebook-f"></i> Facebook</a>
  </div>
  <div class="col-sm">
    <a class="text-white " href="#"><i class="fab fa-twitter"></i> Twitter</a>
  </div>
  <div class="col-sm">
    <a class="text-white " href="#"><i class="fab fa-whatsapp"></i> WhatsApp</a>
  </div>
  <div class="col-sm">
...
<div class="container-fluid p-4" style="background-color:#E9ECEF">
  <div class="container" style="background-color:#E9ECEF">
    <div class="row text-center">
      <div class="col-sm">
        <h5>About Us</h5>
        <p>InsightIQ provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
      </div>
      <div class="col-sm">
        <h5>Category</h5>
      ...
      <div class="col-sm">
        <h5>Contact Us</h5>
        <p>InsightIQ <br> Ekattuthangal <br> Chennai, Tamil Nadu <br> Ph. 99420 53001 </p>
      </div>
    </div>
  </div>
